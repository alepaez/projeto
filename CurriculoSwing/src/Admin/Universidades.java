...
public class Universidades extends JFrame {
	...
	public Universidades() {
		...
		try {
			...
			List<Universidade> listaUniversidades = universidadeDao.list();
		...
		btnNovaUniversidade.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dispose();
				new NovaUniversidade().setVisible(true);
			}
		});
		...
		btnEditar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					InitialContext ic = new InitialContext();
					UniversidadeRemote universidadeDao = (UniversidadeRemote)ic.lookup("java:global/curriculoEAR/curriculo/UniversidadeDao");
					new EditarUniversidade(universidadeDao.find(Integer.parseInt((String) table.getValueAt(table.getSelectedRow(), 0)))).setVisible(true);
				} catch (NamingException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
