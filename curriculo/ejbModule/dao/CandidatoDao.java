...
public class CandidatoDao implements CandidatoRemote {
	...
	public Candidato find(String login) {
		TypedQuery<Candidato> query = em.createQuery("select cl from Candidato cl where cl.login = '" + login + "'", Candidato.class);
	...
	public List<Candidato> list() {
		TypedQuery<Candidato> query = em.createQuery("select cl from Candidato cl", Candidato.class); 
